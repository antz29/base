...
define('ROOT',realpath(dirname(dirname($_SERVER['SCRIPT_FILENAME']))) . '/');
define('PUBLIC_ROOT',realpath(dirname($_SERVER['SCRIPT_FILENAME'])) . '/');

define("APP_ROOT",realpath(dirname(dirname(dirname(__FILE__)))).'/');
define("BASE_ROOT",realpath(APP_ROOT.'vendor/base').'/');
